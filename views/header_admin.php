...
<head>
    ...
    <meta name="keywords" content="<?php if(isset($this->keywords)) { echo $this->keywords; } else { echo "Golden, Golden"; } ?>" />
...
<body class="admin <?php if(isset($this->NavBold)){ echo $this->NavBold;} ?> <?php if(isset($this->NavSub)){ echo $this->NavSub;} ?>">
<header class="container col-xs-12">
    <div id="LogoA" class="col-xs-2 col-xs-offset-0 col-sm-2 col-sm-offset-2 col-md-2 col-md-offset-2">
        <a href="/" class="">
